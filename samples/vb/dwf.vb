...
Module dwf
    ...
    Public Const devidSaluki As Integer       = 6
    ...
    Function FDwfDigitalIOOutputEnableInfo(ByVal hdwf As Integer, ByRef pfsOutputEnableMask As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalIOOutputEnableGet(ByVal hdwf As Integer, ByRef pfsOutputEnable As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalIOOutputInfo", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalIOOutputInfo(ByVal hdwf As Integer, ByRef pfsOutputMask As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalIOOutputGet(ByVal hdwf As Integer, ByRef pfsOutput As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalIOInputInfo", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalIOInputInfo(ByVal hdwf As Integer, ByRef pfsInputMask As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalIOInputStatus", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalIOInputStatus(ByVal hdwf As Integer, ByRef pfsInput As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInDividerInfo(ByVal hdwf As Integer, ByRef pdivMax As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInDividerGet(ByVal hdwf As Integer, ByRef pdiv As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInSampleSensibleGet(ByVal hdwf As Integer, ByRef pfs As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInTriggerPositionInfo(ByVal hdwf As Integer, ByRef pnSamplesAfterTriggerMax As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInTriggerPositionGet(ByVal hdwf As Integer, ByRef pcSamplesAfterTrigger As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInTriggerPrefillGet(ByVal hdwf As Integer, ByRef pcSamplesBeforeTrigger As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInTriggerInfo(ByVal hdwf As Integer, ByRef pfsLevelLow As Integer, ByRef pfsLevelHigh As Integer, ByRef pfsEdgeRise As Integer, ByRef pfsEdgeFall As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalInTriggerGet(ByVal hdwf As Integer, ByRef pfsLevelLow As Integer, ByRef pfsLevelHigh As Integer, ByRef pfsEdgeRise As Integer, ByRef pfsEdgeFall As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutRepeatInfo(ByVal hdwf As Integer, ByRef pnMin As Integer, ByRef pnMax As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutRepeatGet(ByVal hdwf As Integer, ByRef pcRepeat As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalOutRepeatStatus", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalOutRepeatStatus(ByVal hdwf As Integer, ByRef pcRepeat As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutDividerInfo(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef vMin As Integer, ByRef vMax As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalOutDividerInitSet", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalOutDividerInitSet(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByVal v As Integer) As Integer
    End Function

    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalOutDividerInitGet", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalOutDividerInitGet(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef pv As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutDividerGet(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef pv As Integer) As Integer
    End Function


    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalOutCounterInfo", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalOutCounterInfo(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef vMin As Integer, ByRef vMax As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutCounterInitGet(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef pfHigh As Integer, ByRef pv As Integer) As Integer
    End Function
    ...
    Function FDwfDigitalOutCounterGet(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef pvLow As Integer, ByRef pvHigh As Integer) As Integer
    End Function



    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalOutDataInfo", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalOutDataInfo(ByVal hdwf As Integer, ByVal idxChannel As Integer, ByRef pcountOfBitsMax As Integer) As Integer
    End Function
    ...
    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalSpiWrite", CallingConvention:=CallingConvention.Cdecl)>
    Function FDwfDigitalSpiWrite32(ByVal hdwf As Integer, ByVal cDQ As Integer, ByVal cBitPerWord As Integer, <MarshalAs(UnmanagedType.LPArray)> rgTX() As Integer, ByVal cTX As Integer) As Integer
    End Function


    <DllImport("dwf.dll", EntryPoint:="FDwfDigitalI", CallingConvention:=CallingConvention.Cdecl)>
